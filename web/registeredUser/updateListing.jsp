<%-- 
    ...
    Created on : Mar 4, 2022, 4:39:34 PM
    Author     : strix
--%>
...
<body>
  ...
  <div class="container">
    ...
    <div class="content">
      <form action="<%=request.getContextPath()%>/UpdateListing" method="POST">
        <div class="user-details">
          <div class="input-box">
            <span class="details">Database ID</span>
            <input type="int" placeholder="Enter Listing's Database ID" name="id" required>
          </div>
          <div class="input-box">
